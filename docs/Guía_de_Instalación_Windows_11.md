...
Verifica si tu equipo es compatible con Windows 11
...
Crea un USB de arranque con la imagen ISO de Windows 11
...
Configura la BIOS de tu equipo
...
5 pasos clave antes de instalar Windows 11
...
Por último, deberás descargar la herramienta de creación de medios de Microsoft para instalar Windows 11. Esta herramienta te ayudará a crear un archivo ISO o una unidad USB de arranque para instalar el nuevo sistema operativo en tu ordenador. 

Puedes descargar la herramienta de creación de medios directamente desde el sitio web de Microsoft.
